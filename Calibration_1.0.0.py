...
# Read raw data(Filename extension : .xlsx, Matrix shape of raw data ; 48x48)
dir1 = 'C:\\Users\\A\\Desktop\\bias_test\\1bar\\22.02.28.38'
dir2 = 'C:\\Users\\A\\Desktop\\bias_test\\7bar\\22.02.28.38'
excelFile1 = os.path.join(dir1, '22.02.28.38-2d.xlsx')
data1 = pd.read_excel(excelFile1)
dataA = np.array(data1,dtype='int32')
excelFile2 = os.path.join(dir2, '22.02.28.38-2d.xlsx')
...
F1PRE1= abs(F1-Total_sumc[0]/1000)*100
F2PRE1=abs(F2-Total_sumc[1]/1000)*100
print('---------------------------------------------------------Result of calibration--------------------------------------------------------')
d=[['1bar', F1/9.8, Total_sumc[0]/9800, round(Total_sumc[0]/9800,3), F1PRE1],['7bar', F2/9.8, Total_sumc[1]/9800, round(Total_sumc[1]/9800,3), F2PRE1]]
